...
gdjs.Level2Code.GDCloseBtnObjects2_1final = [];

gdjs.Level2Code.GDPlayerObjects2_1final = [];

gdjs.Level2Code.GDPlayerObjects3_1final = [];

gdjs.Level2Code.GDendingObjects2_1final = [];
...
gdjs.Level2Code.GDMain_9595MenuObjects1= [];
gdjs.Level2Code.GDMain_9595MenuObjects2= [];
gdjs.Level2Code.GDMain_9595MenuObjects3= [];
gdjs.Level2Code.GDMain_9595MenuObjects4= [];
gdjs.Level2Code.GDContestObjects1= [];
gdjs.Level2Code.GDContestObjects2= [];
gdjs.Level2Code.GDContestObjects3= [];
gdjs.Level2Code.GDContestObjects4= [];
...
gdjs.Level2Code.GDendingObjects1= [];
gdjs.Level2Code.GDendingObjects2= [];
gdjs.Level2Code.GDendingObjects3= [];
gdjs.Level2Code.GDendingObjects4= [];
gdjs.Level2Code.GDendTextObjects1= [];
gdjs.Level2Code.GDendTextObjects2= [];
gdjs.Level2Code.GDendTextObjects3= [];
gdjs.Level2Code.GDendTextObjects4= [];
gdjs.Level2Code.GDCloseBtnObjects1= [];
gdjs.Level2Code.GDCloseBtnObjects2= [];
gdjs.Level2Code.GDCloseBtnObjects3= [];
gdjs.Level2Code.GDCloseBtnObjects4= [];
gdjs.Level2Code.GDplayer_9595inputObjects1= [];
gdjs.Level2Code.GDplayer_9595inputObjects2= [];
gdjs.Level2Code.GDplayer_9595inputObjects3= [];
gdjs.Level2Code.GDplayer_9595inputObjects4= [];
gdjs.Level2Code.GDnamenameObjects1= [];
gdjs.Level2Code.GDnamenameObjects2= [];
gdjs.Level2Code.GDnamenameObjects3= [];
gdjs.Level2Code.GDnamenameObjects4= [];
gdjs.Level2Code.GDMutedObjects1= [];
gdjs.Level2Code.GDMutedObjects2= [];
gdjs.Level2Code.GDMutedObjects3= [];
gdjs.Level2Code.GDMutedObjects4= [];
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22205052);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22205564);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22208356);
}
}
if (isConditionTrue_0) {
...
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDDustParticleObjects3Objects = Hashtable.newFrom({"DustParticle": gdjs.Level2Code.GDDustParticleObjects3});
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22221388);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDPlayerObjects3 */
{for(var i = 0, len = gdjs.Level2Code.GDPlayerObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDPlayerObjects3[i].getBehavior("PlatformerObject").setCanJump();
}
}{runtimeScene.getScene().getVariables().get("jumpCount").add(1);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22217068);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22216572);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDPlayerObjects3 */
...
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDDustParticleObjects3Objects, (( gdjs.Level2Code.GDPlayerObjects3.length === 0 ) ? 0 :gdjs.Level2Code.GDPlayerObjects3[0].getAABBCenterX()), (( gdjs.Level2Code.GDPlayerObjects3.length === 0 ) ? 0 :gdjs.Level2Code.GDPlayerObjects3[0].getAABBBottom()), "");
}{for(var i = 0, len = gdjs.Level2Code.GDDustParticleObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDDustParticleObjects3[i].setZOrder(-(1));
}
}{for(var i = 0, len = gdjs.Level2Code.GDDustParticleObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDDustParticleObjects3[i].setAngle(270);
}
}}
...
for (var i = 0, k = 0, l = gdjs.Level2Code.GDPlayerObjects4.length;i<l;++i) {
    if ( gdjs.Level2Code.GDPlayerObjects4[i].getBehavior("PlatformerObject").isJumping() ) {
        isConditionTrue_1 = true;
...
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.Level2Code.GDPlayerObjects4);
for (var i = 0, k = 0, l = gdjs.Level2Code.GDPlayerObjects4.length;i<l;++i) {
    if ( gdjs.Level2Code.GDPlayerObjects4[i].getBehavior("PlatformerObject").isFalling() ) {
        isConditionTrue_1 = true;
        gdjs.Level2Code.GDPlayerObjects4[k] = gdjs.Level2Code.GDPlayerObjects4[i];
        ++k;
    }
...
{for(var i = 0, len = gdjs.Level2Code.GDEndScreenSubHeaderObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenSubHeaderObjects3[i].getBehavior("Text").setText("Wow! You scored " + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(1)) + " points within " + gdjs.evtTools.common.toString(Math.round(Math.abs(gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSeconds(runtimeScene, "Level")))) + " seconds!" + gdjs.evtTools.string.newLine() + "Submit your score to have a chance to win exclusive prizes now!");
}
}}
...
};gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDEndScreenBackgroundObjects3Objects = Hashtable.newFrom({"EndScreenBackground": gdjs.Level2Code.GDEndScreenBackgroundObjects3});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22249428);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("Contest"), gdjs.Level2Code.GDContestObjects3);
gdjs.copyArray(runtimeScene.getObjects("EndScreenBackground"), gdjs.Level2Code.GDEndScreenBackgroundObjects3);
...
gdjs.copyArray(runtimeScene.getObjects("EndScreenHeader"), gdjs.Level2Code.GDEndScreenHeaderObjects3);
gdjs.copyArray(runtimeScene.getObjects("EndScreenRetryText"), gdjs.Level2Code.GDEndScreenRetryTextObjects3);
gdjs.copyArray(runtimeScene.getObjects("EndScreenSubHeader"), gdjs.Level2Code.GDEndScreenSubHeaderObjects3);
gdjs.copyArray(runtimeScene.getObjects("Main_Menu"), gdjs.Level2Code.GDMain_9595MenuObjects3);
gdjs.copyArray(runtimeScene.getObjects("RetryButton"), gdjs.Level2Code.GDRetryButtonObjects3);
{gdjs.evtsExt__UserInterface__StretchToFillScreen.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDEndScreenBackgroundObjects3Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{for(var i = 0, len = gdjs.Level2Code.GDEndScreenBackgroundObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenBackgroundObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenHeaderObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenHeaderObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenSubHeaderObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenSubHeaderObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenBestTextObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenBestTextObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenChallengeTextObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenChallengeTextObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenRetryTextObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenRetryTextObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDRetryButtonObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDRetryButtonObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDMain_9595MenuObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDMain_9595MenuObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDContestObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDContestObjects3[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
}{for(var i = 0, len = gdjs.Level2Code.GDMain_9595MenuObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDMain_9595MenuObjects3[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) / 2);
}
}{for(var i = 0, len = gdjs.Level2Code.GDRetryButtonObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDRetryButtonObjects3[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * 1.3 / 4);
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDRetryButtonObjects3.length;i<l;++i) {
    if ( gdjs.Level2Code.GDRetryButtonObjects3[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDRetryButtonObjects3[k] = gdjs.Level2Code.GDRetryButtonObjects3[i];
        ++k;
    }
}
gdjs.Level2Code.GDRetryButtonObjects3.length = k;
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDMain_9595MenuObjects3.length;i<l;++i) {
    if ( gdjs.Level2Code.GDMain_9595MenuObjects3[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDMain_9595MenuObjects3[k] = gdjs.Level2Code.GDMain_9595MenuObjects3[i];
        ++k;
    }
}
gdjs.Level2Code.GDMain_9595MenuObjects3.length = k;
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Contest"), gdjs.Level2Code.GDContestObjects2);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDContestObjects2.length;i<l;++i) {
    if ( gdjs.Level2Code.GDContestObjects2[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDContestObjects2[k] = gdjs.Level2Code.GDContestObjects2[i];
        ++k;
    }
}
...
};gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDEndScreenBackgroundObjects1Objects = Hashtable.newFrom({"EndScreenBackground": gdjs.Level2Code.GDEndScreenBackgroundObjects1});
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("Contest"), gdjs.Level2Code.GDContestObjects1);
gdjs.copyArray(runtimeScene.getObjects("EndScreenBackground"), gdjs.Level2Code.GDEndScreenBackgroundObjects1);
gdjs.copyArray(runtimeScene.getObjects("EndScreenBestText"), gdjs.Level2Code.GDEndScreenBestTextObjects1);
gdjs.copyArray(runtimeScene.getObjects("EndScreenChallengeText"), gdjs.Level2Code.GDEndScreenChallengeTextObjects1);
gdjs.copyArray(runtimeScene.getObjects("EndScreenHeader"), gdjs.Level2Code.GDEndScreenHeaderObjects1);
gdjs.copyArray(runtimeScene.getObjects("EndScreenRetryText"), gdjs.Level2Code.GDEndScreenRetryTextObjects1);
gdjs.copyArray(runtimeScene.getObjects("EndScreenSubHeader"), gdjs.Level2Code.GDEndScreenSubHeaderObjects1);
gdjs.copyArray(runtimeScene.getObjects("Main_Menu"), gdjs.Level2Code.GDMain_9595MenuObjects1);
gdjs.copyArray(runtimeScene.getObjects("RetryButton"), gdjs.Level2Code.GDRetryButtonObjects1);
gdjs.copyArray(runtimeScene.getObjects("endText"), gdjs.Level2Code.GDendTextObjects1);
gdjs.copyArray(runtimeScene.getObjects("ending"), gdjs.Level2Code.GDendingObjects1);
{for(var i = 0, len = gdjs.Level2Code.GDendingObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDendingObjects1[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) / 2);
}
}{gdjs.evtsExt__UserInterface__StretchToFillScreen.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDEndScreenBackgroundObjects1Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{for(var i = 0, len = gdjs.Level2Code.GDEndScreenBackgroundObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenBackgroundObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenHeaderObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenHeaderObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenSubHeaderObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenSubHeaderObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenBestTextObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenBestTextObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenChallengeTextObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenChallengeTextObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDEndScreenRetryTextObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDEndScreenRetryTextObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDRetryButtonObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDRetryButtonObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDMain_9595MenuObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDMain_9595MenuObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
for(var i = 0, len = gdjs.Level2Code.GDContestObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDContestObjects1[i].setCenterXInScene(gdjs.evtTools.camera.getCameraX(runtimeScene, "EndScreen", 0));
}
}{for(var i = 0, len = gdjs.Level2Code.GDendTextObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDendTextObjects1[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * 0.24);
}
}}
...
isConditionTrue_0 = gdjs.evtTools.runtimeScene.sceneJustBegins(runtimeScene);
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("CloseBtn"), gdjs.Level2Code.GDCloseBtnObjects2);
...
}{for(var i = 0, len = gdjs.Level2Code.GDCloseBtnObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDCloseBtnObjects2[i].Activate(false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22243260);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("ending"), gdjs.Level2Code.GDendingObjects2);
...
}{for(var i = 0, len = gdjs.Level2Code.GDendingObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDendingObjects2[i].resetTimer("endingmessage");
}
}
{ //Subevents
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDendingObjects2.length;i<l;++i) {
    if ( gdjs.Level2Code.GDendingObjects2[i].getTimerElapsedTimeInSecondsOrNaN("endingmessage") >= 2 ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDendingObjects2[k] = gdjs.Level2Code.GDendingObjects2[i];
        ++k;
    }
}
gdjs.Level2Code.GDendingObjects2.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
{runtimeScene.getScene().getVariables().getFromIndex(0).setNumber(1);
    ...
    gdjs.Level2Code.GDCloseBtnObjects2[i].Activate(true, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
...
gdjs.Level2Code.GDCloseBtnObjects2.length = 0;

gdjs.Level2Code.GDendingObjects2.length = 0;


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{gdjs.Level2Code.GDCloseBtnObjects2_1final.length = 0;
gdjs.Level2Code.GDendingObjects2_1final.length = 0;
let isConditionTrue_1 = false;
isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("ending"), gdjs.Level2Code.GDendingObjects3);
for (var i = 0, k = 0, l = gdjs.Level2Code.GDendingObjects3.length;i<l;++i) {
    if ( gdjs.Level2Code.GDendingObjects3[i].getTimerElapsedTimeInSecondsOrNaN("endingmessage") >= 16 ) {
        isConditionTrue_1 = true;
        gdjs.Level2Code.GDendingObjects3[k] = gdjs.Level2Code.GDendingObjects3[i];
        ++k;
    }
}
gdjs.Level2Code.GDendingObjects3.length = k;
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.Level2Code.GDendingObjects3.length; j < jLen ; ++j) {
        if ( gdjs.Level2Code.GDendingObjects2_1final.indexOf(gdjs.Level2Code.GDendingObjects3[j]) === -1 )
            gdjs.Level2Code.GDendingObjects2_1final.push(gdjs.Level2Code.GDendingObjects3[j]);
    }
}
}
{
gdjs.copyArray(runtimeScene.getObjects("CloseBtn"), gdjs.Level2Code.GDCloseBtnObjects3);
for (var i = 0, k = 0, l = gdjs.Level2Code.GDCloseBtnObjects3.length;i<l;++i) {
    if ( gdjs.Level2Code.GDCloseBtnObjects3[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_1 = true;
        gdjs.Level2Code.GDCloseBtnObjects3[k] = gdjs.Level2Code.GDCloseBtnObjects3[i];
        ++k;
    }
}
gdjs.Level2Code.GDCloseBtnObjects3.length = k;
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.Level2Code.GDCloseBtnObjects3.length; j < jLen ; ++j) {
        if ( gdjs.Level2Code.GDCloseBtnObjects2_1final.indexOf(gdjs.Level2Code.GDCloseBtnObjects3[j]) === -1 )
            gdjs.Level2Code.GDCloseBtnObjects2_1final.push(gdjs.Level2Code.GDCloseBtnObjects3[j]);
    }
}
}
{
gdjs.copyArray(gdjs.Level2Code.GDCloseBtnObjects2_1final, gdjs.Level2Code.GDCloseBtnObjects2);
gdjs.copyArray(gdjs.Level2Code.GDendingObjects2_1final, gdjs.Level2Code.GDendingObjects2);
}
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22247572);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.camera.hideLayer(runtimeScene, "EndingMsg");
...
gdjs.copyArray(runtimeScene.getObjects("Timer"), gdjs.Level2Code.GDTimerObjects3);
{for(var i = 0, len = gdjs.Level2Code.GDTimerObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDTimerObjects3[i].setCenterXInScene(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) / 2);
}
}}
...
{for(var i = 0, len = gdjs.Level2Code.GDScoreTextObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDScoreTextObjects2[i].getBehavior("Text").setText("Score: " + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(1)));
}
...
};gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDMutedObjects2Objects = Hashtable.newFrom({"Muted": gdjs.Level2Code.GDMutedObjects2});
gdjs.Level2Code.eventsList24 = function(runtimeScene) {

{

gdjs.copyArray(gdjs.Level2Code.GDMutedObjects2, gdjs.Level2Code.GDMutedObjects3);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDMutedObjects3.length;i<l;++i) {
    if ( gdjs.Level2Code.GDMutedObjects3[i].getVariableBoolean(gdjs.Level2Code.GDMutedObjects3[i].getVariables().getFromIndex(0), false) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDMutedObjects3[k] = gdjs.Level2Code.GDMutedObjects3[i];
        ++k;
    }
}
gdjs.Level2Code.GDMutedObjects3.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDMutedObjects3 */
{for(var i = 0, len = gdjs.Level2Code.GDMutedObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDMutedObjects3[i].getBehavior("Animation").setAnimationName("muted");
}
}{for(var i = 0, len = gdjs.Level2Code.GDMutedObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDMutedObjects3[i].toggleVariableBoolean(gdjs.Level2Code.GDMutedObjects3[i].getVariables().getFromIndex(0));
}
...
/* Reuse gdjs.Level2Code.GDMutedObjects2 */

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDMutedObjects2.length;i<l;++i) {
    if ( gdjs.Level2Code.GDMutedObjects2[i].getVariableBoolean(gdjs.Level2Code.GDMutedObjects2[i].getVariables().getFromIndex(0), true) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDMutedObjects2[k] = gdjs.Level2Code.GDMutedObjects2[i];
        ++k;
    }
}
gdjs.Level2Code.GDMutedObjects2.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDMutedObjects2 */
{for(var i = 0, len = gdjs.Level2Code.GDMutedObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDMutedObjects2[i].getBehavior("Animation").setAnimationName("unmuted");
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDMutedObjects2Objects, runtimeScene, true, false);
}
if (isConditionTrue_0) {
...
/* Reuse gdjs.Level2Code.GDMutedObjects3 */
{for(var i = 0, len = gdjs.Level2Code.GDMutedObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDMutedObjects3[i].getBehavior("Animation").setAnimationName("unmuted");
}
}{gdjs.evtTools.sound.setGlobalVolume(runtimeScene, 100);
}}
...
/* Reuse gdjs.Level2Code.GDMutedObjects2 */
{for(var i = 0, len = gdjs.Level2Code.GDMutedObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDMutedObjects2[i].getBehavior("Animation").setAnimationName("muted");
}
}{gdjs.evtTools.sound.setGlobalVolume(runtimeScene, 0);
}}
...
/* Reuse gdjs.Level2Code.GDMutedObjects2 */
{for(var i = 0, len = gdjs.Level2Code.GDMutedObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDMutedObjects2[i].toggleVariableBoolean(gdjs.Level2Code.GDMutedObjects2[i].getVariables().getFromIndex(0));
}
}
{ //Subevents
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Muted"), gdjs.Level2Code.GDMutedObjects2);
{for(var i = 0, len = gdjs.Level2Code.GDMutedObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDMutedObjects2[i].getBehavior("Animation").setAnimationName("muted");
}
}
...
gdjs.Level2Code.GDMain_9595MenuObjects1.length = 0;
gdjs.Level2Code.GDMain_9595MenuObjects2.length = 0;
gdjs.Level2Code.GDMain_9595MenuObjects3.length = 0;
gdjs.Level2Code.GDMain_9595MenuObjects4.length = 0;
gdjs.Level2Code.GDContestObjects1.length = 0;
gdjs.Level2Code.GDContestObjects2.length = 0;
gdjs.Level2Code.GDContestObjects3.length = 0;
gdjs.Level2Code.GDContestObjects4.length = 0;
...
gdjs.Level2Code.GDendingObjects1.length = 0;
gdjs.Level2Code.GDendingObjects2.length = 0;
gdjs.Level2Code.GDendingObjects3.length = 0;
gdjs.Level2Code.GDendingObjects4.length = 0;
gdjs.Level2Code.GDendTextObjects1.length = 0;
gdjs.Level2Code.GDendTextObjects2.length = 0;
gdjs.Level2Code.GDendTextObjects3.length = 0;
gdjs.Level2Code.GDendTextObjects4.length = 0;
gdjs.Level2Code.GDCloseBtnObjects1.length = 0;
gdjs.Level2Code.GDCloseBtnObjects2.length = 0;
gdjs.Level2Code.GDCloseBtnObjects3.length = 0;
gdjs.Level2Code.GDCloseBtnObjects4.length = 0;
gdjs.Level2Code.GDplayer_9595inputObjects1.length = 0;
gdjs.Level2Code.GDplayer_9595inputObjects2.length = 0;
gdjs.Level2Code.GDplayer_9595inputObjects3.length = 0;
gdjs.Level2Code.GDplayer_9595inputObjects4.length = 0;
gdjs.Level2Code.GDnamenameObjects1.length = 0;
gdjs.Level2Code.GDnamenameObjects2.length = 0;
gdjs.Level2Code.GDnamenameObjects3.length = 0;
gdjs.Level2Code.GDnamenameObjects4.length = 0;
gdjs.Level2Code.GDMutedObjects1.length = 0;
gdjs.Level2Code.GDMutedObjects2.length = 0;
gdjs.Level2Code.GDMutedObjects3.length = 0;
gdjs.Level2Code.GDMutedObjects4.length = 0;
